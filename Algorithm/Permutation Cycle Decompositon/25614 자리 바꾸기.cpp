//Big integer 구현체를 가져와서 사용했다.
//https://codeforces.com/blog/entry/16380

//M이 상당히 크고 길기에 string에 받은 후 bigint로 변환해줘야 했다.
//또 큰 수 연산을 처음 써봐서 몰랐던건데, 수가 커질수록 연산이 무거워지기에 사용했던 연산 결과를 저장해주어야 TLE를 받지 않는다.
//아이디어는 크게 어렵지 않은데 Bigint가 발목을 붙잡던 문제였다.
